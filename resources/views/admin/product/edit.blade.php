...
<div class="content__inner">
        ...
        <div class="card-body">
            ...
            <form action="{{route('product.update',$product->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <input type="text" class="form-control" placeholder="eg: Vợt cầu lông" name="name" required value="{{old('name',isset($product)? $product->name: null)}}">
                ...
                <div class="form-group ">
                  <select class="select2" name="category_id" >
                      ...
                      @php
                      showCategories($data,0,$str='--|',$product->category_id);
                      @endphp
                  </select>
              </div>
              ...
              <div class="form-group ">
                  <select class="select2" name="brand_id" >
                      ...
                      @php
                      showCategories($listBrand,0,$str='--|',$product->brand_id);
                      @endphp
                  </select>
              </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="form-group">
                    <div class="toggle-switch">
                        <input type="checkbox" class="toggle-switch__checkbox" {{$product->status==1? "checked":null}} name="status">
            ...
            <div class="col-md-4">
             ...
             <div class="form-group">
                <div class="toggle-switch">
                    <input type="checkbox" class="toggle-switch__checkbox" {{$product->featured==1? "checked":null}}  name="featured">
                    <i class="toggle-switch__helper"></i>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Giá thường" name="price" value="{{old('price',isset($product)? $product->price: null)}}">
                <i class="form-group__bar"></i>
            </div>
        ...
        <div class="col-md-4">
           <div class="form-group">
            <input type="text" class="form-control" placeholder="Giá khuyến mại" name="sale_price" value="{{old('sale_price',isset($product)? $product->sale_price: null)}}">
            <i class="form-group__bar"></i>
        </div>
    </div>
</div>
...
<div class="form-group">
    <textarea class="form-control textarea-autosize" placeholder="Nội dung..." name="short_description">{{old('short_description',isset($product)? $product->short_description: null)}}</textarea>
    <i class="form-group__bar"></i>
</div> 
...
<div class="btn-demo">
    ...
    <button class="btn btn-light pull-right" type="submit">Cập nhật sản phẩm</button>
</div>
